 ...
 */  
 ...
 public class InicioVista extends JFrame {
     ...
     private JMenuItem menuItemConceptos;
     private JLabel numConceptos; 
    ...
    private InicioControlador controlador;
     ...
     private void initComponents() {
         ...
         menuItemConceptos = new JMenuItem("Ver Conceptos");
         //menuItemConceptos.addActionListener(this);
         menuItemConceptos.setBackground(Color.GREEN);
         menuBar.add(menuItemConceptos);
         
 
         // Panel para mostrar la pregunta
         JPanel inicioPanel = new JPanel(new FlowLayout(FlowLayout.CENTER));
 
         numConceptos = new JLabel("Hay en el sistema " + 1001 +" conceptos");
         numConceptos.setBounds(0, 180, 100, 200);
         inicioPanel.add(numConceptos);
    ...
    public void setFileHandler(FileHandler<Concepto> fileHandler) {
        this.fileHandler = fileHandler;
    }
   ...
   /* public void setItemAdmin(JMenuItem menuItemAdmin){
    ...
    public JMenuItem getItemConceptos() {
        return menuItemConceptos;
    }

    /*public void setItemConceptos(JMenuItem menuItemConceptos){
        this.menuItemConceptos = menuItemConceptos;
    }*/

    public JLabel getLabelConceptos() {
        return numConceptos;
    }

    public void setLabelConceptos(JLabel  numConceptos){
...
/*
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (e.getSource() == menuItemConceptos) {
